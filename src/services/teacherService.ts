...
export const registerTeacherService = async ({ username, email, password, classroomName }: any) => {
    ...
    const classroom = new Classroom({ name: classroomName, teacher: teacher._id });
